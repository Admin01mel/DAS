            ...
            if(waktu_sekarang-waktu_sebelum[0]>=waktu[0]):
                ...
                for i,chnData in enumerate(dataNotifNew):
                    ...
                    if (kondisi==0 and chnData["tel_low"]==1):
                        db.requestData.sendNotif(chnData["kode_mesin"],chnData["nama_gi"],chnData["nama_alat"],chnData["nama_mesin"],chnData["port"],chnData["tanggal"],chnData["status"],chnData["flag_kondisi"],chnData["ipserver"],chnData["api"],chnData["chatid"])
                    ...
                    iterator = sendNotification(
                        ...
                        UdpTransportTarget(('192.168.85.168', 162)),
                        ContextData(),
                        'trap',
                        NotificationType(
                            ...
                            ('1.3.6.1.2.1.1.1.0', OctetString("GI :" +chnData["nama_gi"]+" ,Nama :"+chnData["nama_alat"]+" ,Status:"+chnData["status"]+" ,Port:"+str(chnData["port"])))
                        ).loadMibs(
                            'SNMPv2-MIB'
                        )
                    )
