            ...
            if(waktu_sekarang-waktu_sebelum[0]>=waktu[0]):
                ...
                for i,chnData in enumerate(dataNotifNew):
                    ...
                    if (kondisi==0 and chnData["tel_low"]==1):
                        db.requestData.sendNotif(chnData["kode_mesin"],chnData["nama_gi"],chnData["nama_alat"],chnData["nama_mesin"],chnData["port"],chnData["tanggal"],chnData["status"],chnData["flag_kondisi"],chnData["ipserver"],chnData["api"],chnData["chatid"],chnData["idm"],chnData["ipgipat"])
