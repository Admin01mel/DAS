...
<body style="background-color:#1c222c" oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
  ...
  <div class="fixed-bottom d-flex justify-content-between align-content-md-stretch bg-dark" style="padding-top:1px;padding-bottom:1px;">
    ...
    <a id="btn-home" class="flex-fill btn  text-center text-success" onclick="gotohome()">
      ...
      HOME</a>
    <a id="btn-home" class="flex-fill btn  text-center text-primary" onclick="gotopower()">
      <i class="fas fa-bolt icon-nav" aria-hidden="true">&nbsp</i><br>
      POWER</a>
  ...
  <script src="<?php echo base_url('assets/theme/js/mqttws31.js') ?>"></script>
  <script src="<?php echo base_url('assets/theme/js/config.js') ?>"></script>
  <script src="<?php echo base_url('assets/theme/js/raphael-2.1.4.min.js') ?>"></script>
  <script src="<?php echo base_url('assets/theme/js/justgage.js') ?>"></script>
  ...
  <script>
    ...
    function gotosetting() {
      ...
      $("#main").load("main/config.php?u=<?php echo $username ?>&l=<?php echo $level ?>");
    }
    ...
    function gotopower() {
      ...
      $("#btn-home").removeClass("text-secondary")
      $("#btn-home").addClass("text-success")
      $("#main").load("main/power.php?p=<?php echo $port ?>");
      $("#key").hide()
      //window.location.reload();
    }
